...
/* Indicates here all the uniforms that are used by the shader.
   ...
   You can specify the type, min, max and default values for the uniforms using a json object preceding the uniform declaration.
   Min, max and default type must match the uniform type.
*/
